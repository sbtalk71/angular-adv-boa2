...
export const routes: Routes = [
    ...
    {path:'remove',loadComponent:()=>import('./pages/remove-user/remove-user.component').then(m=>m.RemoveUserComponent)},
    {path:'edituser',loadComponent:()=>import('./pages/edit-user/edit-user.component').then(m=>m.EditUserComponent)},
    {path:'users',loadComponent:()=>import('./pages/list-users/list-users.component').then(m=>m.ListUsersComponent),data:{preload:true}},
    {path:'usersdetails',loadComponent:()=>import('./pages/user-details/user-details.component').then(m=>m.UserDetailsComponent)},
